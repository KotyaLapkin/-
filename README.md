Шаг 1. Нужно написать программу на С, странслировать его в Assembler с разными опциями оптимизации.

gcc -S -O[0123s] -o <>.s <>.c

 

Программа factorial.c, которая вычисляет факториал:
...
Шаг 2. Разобраться с одним из вариантов [оптимизации] ассемблерной программой (добавить комментарии в сгенерированный ассемблерный код) - найти циклы, переменные и т.п.

 

Ассемблерная программа factorialO1.s с уровнем оптимизации 1:
...
Шаг 3. Преобразовать программу в модульную, разработать Makefile.
